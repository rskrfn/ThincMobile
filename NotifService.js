...
export default class NotifService {
  ...
  localNotif(soundName, message) {
    ...
    PushNotification.localNotification({
      ...
      color: '#5784BA', // (optional) default: system default
      ...
      timeoutAfter: 4000, // (optional) Specifies a duration in milliseconds after which this notification should be canceled, if it is not already canceled, default: null
      ...
      title: 'Thinc', // (optional)
      message: message ? message : 'Welcome', // (required)
